  ...
  work_history: [
    {
      ...
      total_time: '11 meses',
      details: {
        0: 'Responsável pelo desenvolvimento do site, portal de clientes e ecommerce da Paytime, utilizados por mais de <b class="text-blue-light">70.000 clientes</b> e transacionando mais de <b class="text-blue-light">R$ 5 bi</b> anualmente',
